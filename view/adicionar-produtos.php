    ...
    <main>
        ...
        <form action="../view/meus-anuncios.php" class="row g-3 needs-validation" method="post">
            <div id="form-cadastre-se">
                ...
                <input type="text" class="form-control" id="validationCustom01" required placeholder="Insira o nome aqui">
            ...
            <div id="form-cadastre-se">
                ...
                <input type="text" class="form-control" id="validationCustom01" required placeholder="https://...">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" style="width: 50%; margin-left:25%;" id="exampleFormControlTextarea1" rows="5"></textarea>
            </div>
            <div id="form-cadastre-se">
            ...
            <div id="form-cadastre-se">
                ...
                <input type="text" class="form-control" id="validationCustom02" placeholder="Insira o número de unidades" required>
                <div class="invalid-feedback">
